...
// Template 1 — Collabera Brand Guidelines (Figma node 840-4547)

const template1 = {
    id: "collabera-brand-t1",
    name: "Brand Guidelines — Template 1",
    description: "Official Collabera email signature. Newsreader italic name, Red Hat Display body, gold accent #AA9269, LinkedIn icon, and legal footer.",
    html: `
<table cellpadding="0" cellspacing="0" border="0" style="font-family: 'Red Hat Display', Arial, sans-serif; font-size: 16px; color: #05262B; line-height: 1.4; width: 404px; max-width: 404px; text-align: left; background-color: #ffffff;">
    ...
    <tr>
        <td>
            <table cellpadding="0" cellspacing="0" border="0" width="100%">
                ...
                <tr>
                    <td style="font-family: 'Red Hat Display', Arial, sans-serif; font-size: 12px; color: #05262B; font-weight: 400; line-height: 1.6;">
                        <span style="color: #05262B; font-size: 12px; font-family: 'Red Hat Display', Arial, sans-serif;">Give feedback at our</span>
