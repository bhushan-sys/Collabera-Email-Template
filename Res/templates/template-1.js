// Res/templates/template-1.js
// Template 1 — Collabera Brand Guidelines (Figma node 767-1649)
// Layout: Name/Designation/Contact left, optional Top-Right Badges (Women Workplace, Certification),
// Collabera Logo + optional Middle Badges (President's Club, Wlab Wordmark) below, 535px divider line.

const template1 = {
    id: "collabera-brand-t1",
    name: "Brand Guidelines — Template 1",
    description: "Official Collabera email signature with optional logo selection. Newsreader italic name, Red Hat Display body, gold accent #AA9269, LinkedIn icon, and legal footer.",
    html: `
<table cellpadding="0" cellspacing="0" border="0" style="font-family: 'Red Hat Display', Arial, sans-serif; font-size: 16px; color: #05262B; line-height: 1.4; width: 535px; max-width: 535px; text-align: left; background-color: #ffffff;">

    <!-- Top Section: Name, Contact & Top-Right Badges -->
    <tr>
            ...
            <table cellpadding="0" cellspacing="0" border="0" width="100%">
                <tr>
                    ...
                    <td valign="middle" style="width: 150px; min-width: 150px; padding-right: 20px;">
                        <img src="{{profileImage}}" width="150" height="149" alt="Profile Photo" style="display: block; width: 150px; height: 149px; border: 0; outline: none; text-decoration: none; clip-path: url(#avatar-barrel-mask); -webkit-clip-path: url(#avatar-barrel-mask);" />
                    </td>
                    <!-- Vertical Divider Line (Figma node 765:1165) -->
                    <td valign="middle" style="width: 1px; min-width: 1px; padding: 0;">
                        <div style="width: 1px; min-width: 1px; height: 160px; background-color: rgba(5, 38, 43, 0.30); line-height: 1px; font-size: 1px;"></div>
                    </td>
                    <!-- Gap right of Divider Line (Figma 20px gap) -->
                    <td valign="middle" style="width: 20px; min-width: 20px;">&nbsp;</td>
                    {{/if}}
                    <!-- Left: User + Contact Details -->
                    <td valign="middle" style="font-family: 'Red Hat Display', Arial, sans-serif;">
                        <!-- Name & Title -->
                        <table cellpadding="0" cellspacing="0" border="0" style="padding-bottom: 16px;">
                            <tr>
                                <td style="font-family: 'Newsreader', Georgia, 'Times New Roman', serif; font-size: 32px; font-style: italic; font-weight: 300; color: #05262B; line-height: 1.0; padding-bottom: 5px;">
                                    {{name}}
                                </td>
                            </tr>
                            <tr>
                                <td style="font-family: 'Red Hat Display', Arial, sans-serif; font-size: 16px; font-weight: 700; color: #AA9269; line-height: 1.3;">
                                    {{title}}
                                </td>
                            </tr>
                        </table>
                        ...
                        <table cellpadding="0" cellspacing="0" border="0" style="font-family: 'Red Hat Display', Arial, sans-serif; font-size: 16px; color: #05262B; line-height: 1.4;">
                            ...
                            <tr>
                                <td style="padding-bottom: 2px; white-space: nowrap;">
                                    <a href="mailto:{{email}}" style="font-family: 'Red Hat Display', Arial, sans-serif; font-size: 16px; font-weight: 400; color: #05262B; text-decoration: none;">{{email}}</a>
                                </td>
                            </tr>
                            {{/if}}
                            {{#if location != ''}}
                                    ...
                                    <table cellpadding="0" cellspacing="0" border="0">
                                        ...
                                        <tr>
                                            <td style="padding: 0; line-height: normal;">
                                                <a href="https://{{website}}" target="_blank" style="font-family: 'Red Hat Display', Arial, sans-serif; font-size: 16px; font-weight: 400; color: #05262B; text-decoration: none; white-space: nowrap;">{{website}}</a>
                                            </td>
                                        </tr>
                                        {{/if}}
                                        <tr>
                    ...
                    <!-- Right: Top Badges (Women Workplace + Certification Badge) -->
                    <td valign="top" align="right" style="padding-left: 16px;">
                        <table cellpadding="0" cellspacing="0" border="0">
                            <tr>
                                {{#if showWomenWp == 'true'}}
                                <td valign="top" style="padding-left: 16px;">
                                    <img src="https://raw.githubusercontent.com/bhushan-sys/Collabera-Email-Template/main/Res/Women%20Workplace.svg" alt="Most Preferred Workplace for Women" width="56" height="50" style="display: block; width: 56px; height: 50px; border: 0;" />
                                </td>
                                {{/if}}
                                {{#if showCertBadge == 'true'}}
                                <td valign="top" style="padding-left: 16px;">
                                    <img src="https://raw.githubusercontent.com/bhushan-sys/Collabera-Email-Template/main/Res/Collabera_Talent_Solutions_Private_Limited_IN_English_2024_Certification_Badge.svg" alt="Great Place To Work Certified" width="40" height="68" style="display: block; width: 40px; height: 68px; border: 0;" />
                                </td>
                                {{/if}}
                            </tr>
                        </table>
    ...
    <!-- Middle Section: Collabera Logo + Middle Badges Row -->
    <tr>
        <td style="padding-bottom: 20px;">
            <table cellpadding="0" cellspacing="0" border="0" valign="middle">
                <tr>
                    <td valign="middle">
                        <img src="https://raw.githubusercontent.com/bhushan-sys/Collabera-Email-Template/main/Res/Collabera%20Logo.svg" alt="Collabera" width="230" height="33" style="display: block; width: 230px; height: 33px; border: 0; outline: none; text-decoration: none;" />
                    </td>
                    {{#if showPcBadge == 'true'}}
    ...
    <!-- Divider Line (535px matching Figma node 767:1676) -->
    <tr>
        <td style="padding-bottom: 20px;">
            <table cellpadding="0" cellspacing="0" border="0" width="535">
                <tr>
                    <td style="border-top: 1px solid rgba(5, 38, 43, 0.50); height: 1px; line-height: 1px; font-size: 1px;">&nbsp;</td>
                </tr>
            </table>
        </td>
    </tr>

    <!-- Footer: Feedback & Privacy -->
    <tr>
        <td>
            <table cellpadding="0" cellspacing="0" border="0" width="100%">
                <tr>
                ...
                <tr>
                    <td style="font-family: 'Red Hat Display', Arial, sans-serif; font-size: 12px; line-height: 1.6; padding-top: 1px;">
                        ...
                        <a href="http://res.collabera.com/res/email.htm" target="_blank" style="color: #AA9269; font-size: 12px; font-family: 'Red Hat Display', Arial, sans-serif; text-decoration: underline;">Collabera GTC Global Trade &amp; Privacy Compliance Notice</a>
                        {{/if}}
                        {{#if entity == 'Collabera Digital'}}
                        <a href="http://res.collabera.com/res/email.htm" target="_blank" style="color: #AA9269; font-size: 12px; font-family: 'Red Hat Display', Arial, sans-serif; text-decoration: underline;">Collabera Digital Privacy Notice &amp; Email Confidentiality</a>
                        {{/if}}
                    </td>
                </tr>
            </table>
